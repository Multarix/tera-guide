...
const SPAWNING_FIRST_CIRCLE_FLOWERS = [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Right Safe > Inward Waves", "message_RU": "Вправо сейф > Волны внутрь" },
...
const SPAWNING_SECOND_CIRCLE_FLOWERS = [{ "type": "text", "class_position": "tank", "sub_type": "message", "message": "Left Safe > Outward Waves", "message_RU": "Влево сейф > Волны наружу" },
