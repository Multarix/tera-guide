...
module.exports = {
	...
	"s-739-1000-1308-0": [{ "type": "text", "sub_type": "message", "message": "In then Out", "message_RU": "В то время в" },
	...
	"s-739-1000-1306-0": [{ "type": "text", "sub_type": "message", "message": "Out then In", "message_RU": "Из, затем В" },
		{ "type": "func", "func": SpawnCircle.bind(null, false, 553, 0, 0, 10, 300, 0, 7500) }],
	...
	"s-739-3000-1201-0": [{ "type": "text", "sub_type": "message", "delay": 3600, "message": 'Dodge!', "message_RU": "Уклоняйся" }],
	"s-739-3000-2201-0": [{ "type": "text", "sub_type": "message", "delay": 3600, "message": 'Dodge!', "message_RU": "Уклоняйся" }],
	...
	"s-739-3000-1115-0": [{ "type": "text", "sub_type": "message", "message": 'Incoming Stun', "message_RU": "Рёв (Эвейд)!!!" },
		{ "type": "func", "func": SpawnCircle.bind(null, false, 553, 0, 0, 10, 630, 0, 4000) },
		{ "type": "text", "sub_type": "message", "delay": 1500, "message": 'Dodge!', "message_RU": "Уклоняйся" }],
	"s-739-3000-2115-0": [{ "type": "text", "sub_type": "message", "message": 'Incoming Stun', "message_RU": "Рёв (Эвейд)!!!" },
		{ "type": "func", "func": SpawnCircle.bind(null, false, 553, 0, 0, 10, 630, 0, 4000) },
		{ "type": "text", "sub_type": "message", "delay": 1500, "message": 'Dodge!', "message_RU": "Уклоняйся" }],
	...
	"s-739-3000-1175-0": [{ "type": "text", "sub_type": "message", "message": 'Incoming Stun', "message_RU": "Рёв (Эвейд)!!!" },
		{ "type": "func", "func": SpawnCircle.bind(null, false, 553, 0, 0, 10, 630, 0, 4000) },
		{ "type": "text", "sub_type": "message", "delay": 1500, "message": 'Dodge!', "message_RU": "Уклоняйся" }],
	"s-739-3000-2175-0": [{ "type": "text", "sub_type": "message", "message": 'Incoming Stun', "message_RU": "Рёв (Эвейд)!!!" },
		{ "type": "func", "func": SpawnCircle.bind(null, false, 553, 0, 0, 10, 630, 0, 4000) },
		{ "type": "text", "sub_type": "message", "delay": 1500, "message": 'Dodge!', "message_RU": "Уклоняйся" }],
